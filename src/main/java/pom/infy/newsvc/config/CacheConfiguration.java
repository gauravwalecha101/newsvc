package pom.infy.newsvc.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("newsvc");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("newsvc");
        ...
        config.getMapConfigs().put("pom.infy.newsvc.domain.*", initializeDomainMapConfig(jHipsterProperties));
