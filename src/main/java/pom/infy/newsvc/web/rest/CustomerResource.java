...
import pom.infy.newsvc.web.rest.errors.BadRequestAlertException;
import pom.infy.newsvc.web.rest.util.HeaderUtil;
...
@CrossOrigin(origins = "*", allowedHeaders = "*") public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "newsvcCustomer";
